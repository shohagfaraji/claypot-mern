...
export function AccountSecurity({ section }: { section: 'password' | 'sessions' }) {
  ...
  return (
    <>
      <section aria-label={section === 'password' ? 'Password settings' : 'Session settings'}>
          ...
          <Card className="border-border/70 shadow-sm">
            <CardContent className="p-6 sm:p-8">
              ...
              <p className="mt-2 text-sm leading-6 text-muted-foreground">
                Confirm your current password before choosing a new one. Other devices will be
                signed out.
              </p>
